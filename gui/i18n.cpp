...
const Entry kStrings[] = {
    ...
    {"placeholder.url.auto", "粘贴网址——文件或视频页面",
     "Paste a URL — file or video page"},
    ...
    {"label.threads", "线程", "Threads"},
    {"unit.threads", "线程", "threads"},
    {"label.save_to", "保存到", "Save to"},
    {"detected", "识别", "Detected"},
    {"label.state", "状态", "State"},
    {"label.name", "名称", "Name"},
    {"label.progress", "进度", "Progress"},
    {"label.actions", "操作", "Actions"},
    ...
    {"label.tasks", "任务", "Tasks"},
    {"label.type", "类型", "Type"},
    {"label.type_file", "文件", "File"},
    {"label.type_video", "视频", "Video"},
    ...
    {"try_example", "试试示例", "Try an example"},
    {"empty.tasks", "在上方粘贴网址开始。", "Add a URL above to start."},
    {"slots", "个并发任务", "concurrent slots"},
    {"overall", "总计", "Total"},
    {"tasks.unit", "个任务", "tasks"},
    {"chunk", "分片", "Chunk"},
