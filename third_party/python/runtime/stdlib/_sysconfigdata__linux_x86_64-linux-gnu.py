...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CONFIG_ARGS': "'--disable-shared' '--without-tkinter' '--without-ensurepip' "
                "'--without-venv' '--without-test'",
 'CONFINCLUDEDIR': '/usr/local/include',
 'CONFINCLUDEPY': '/usr/local/include/python3.11',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/tmp/Python-3.11.9/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/tmp/Python-3.11.9/lcov-report',
 ...
 'LN': 'ln',
 'LOCALMODLIBS': '-lm       -lm    -lz -lm                  -lbz2  -llzma  '
                 '-lz  -lssl -lcrypto  -L/usr/lib -lcrypto',
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 ...
 'MODBUILT_NAMES': 'atexit  faulthandler  posix  _signal  _tracemalloc  '
                   ...
                   '_operator  _stat  _symtable  pwd  _contextvars  _datetime  '
                   '_heapq  _json  _pickle  _queue  _random  _socket  '
                   '_statistics  _struct  _zoneinfo  array  binascii  math  '
                   'select  _blake2  _md5  _sha1  _sha256  _sha512  _sha3  '
                   '_codecs_cn  _codecs_hk  _codecs_iso2022  _codecs_jp  '
                   '_codecs_kr  _codecs_tw  _multibytecodec  unicodedata  '
                   '_posixsubprocess  _bz2  _lzma  zlib  _ssl  _hashlib  '
                   'xxsubtype',
 'MODDISABLED_NAMES': '',
 'MODLIBS': '-lm       -lm    -lz -lm                  -lbz2  -llzma  -lz  '
            '-lssl -lcrypto  -L/usr/lib -lcrypto',
 'MODOBJS': 'Modules/atexitmodule.o  Modules/faulthandler.o  '
            ...
            'Modules/_contextvarsmodule.o  Modules/_datetimemodule.o  '
            'Modules/_heapqmodule.o  Modules/_json.o  Modules/_pickle.o  '
            'Modules/_queuemodule.o  Modules/_randommodule.o  '
            'Modules/socketmodule.o  Modules/_statisticsmodule.o  '
            'Modules/_struct.o  Modules/_zoneinfo.o  Modules/arraymodule.o  '
            'Modules/binascii.o  Modules/mathmodule.o  Modules/selectmodule.o  '
            ...
            'Modules/_posixsubprocess.o  Modules/_bz2module.o  '
            'Modules/_lzmamodule.o  Modules/zlibmodule.o  Modules/_ssl.o  '
 ...
 'abs_builddir': '/tmp/Python-3.11.9',
 'abs_srcdir': '/tmp/Python-3.11.9',
